  ...
  await db.users.insertMany([
    {
      ...
      followers: ["Funch", "Qyvaden"],
      following: ["Qyvaden", "Funch"],
    ...
    },
    {
      ...
      creationDate: new Date().toLocaleString("en-GB"),
      password: bcrypt.hashSync("123", 10),
      followers: ["Gram", "Qyvaden"],
      following: ["Qyvaden", "Gram"],
      profilePictureKey: "blank_profile.webp",
    },
    {
      _id: user3Id,
      ...
      creationDate: new Date().toLocaleString("en-GB"),
      password: bcrypt.hashSync("123", 10),
      followers: ["Funch", "Gram"],
      following: ["Gram", "Funch"],
      profilePictureKey: "blank_profile.webp",
    },
  ]);
      ...
      comments: [
        {
          ...
          commentAuthor: "Qyvaden",
          commentBody:
            "The new Aqua album is a perfect blend of nostalgia and modern pop. It's like a refreshing breeze from the past mixed with catchy beats that make you want to dance. Aqua has truly delivered another infectious collection of songs that will have you singing along and reminiscing about the good old days. It's a must-listen for both old fans and new listeners!",
          rating: [],
          reported: [],
          timeStamp: new Date().toLocaleString("en-GB"),
          _id: new ObjectId(),
